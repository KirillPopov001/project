...
class Car(Carbase):
    ...
    def __repr__(self):
        return str(self.car_type)+" "+str(self.brand)+" "+str(self.passenger_seats_count)+" "+str(self.photo_le_name)+" "+str(self.carrying)
...
class Truck(Carbase):
    ...
    def __repr__(self):
        if self.body_length == 0.0:
            return str(self.car_type)+" "+str(self.brand)+" "+str(self.photo_le_name)+" "+str(self.carrying)
        else:
            return str(self.car_type)+" "+str(self.brand)+" "+str(self.photo_le_name)+" "+str(self.carrying)+" "+str(self.body_length)+"x"+str(self.body_width)+"x"+str(self.body_height)
...
class Specmachine(Carbase):
    ...
    def __repr__(self):
        return str(self.car_type)+" "+str(self.brand)+" "+str(self.photo_le_name)+" "+str(self.carrying)+" "+str(self.extra)
